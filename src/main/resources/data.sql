...
('단체 가족 보라카이 여행 가이드', '가족 여행의 시작은 철저한 준비로부터', '가족과 함께 떠나는 보라카이 여행을 위한 출발 전 준비사항은 여권, 비자, 여행 보험 등을 포함하여 가족 구성원의 편안한 여행을 위해 필요한 모든 준비물을 체크해야 합니다. 아이들의 건강과 안전을 위한 준비도 빠짐없이 고려하세요.', 700, now(), null, '가족여행'),
...
('편리한 보라카이 패키지 여행 가이드', '편리한 여행을 위한 완벽한 준비', '패키지 여행은 모든 일정을 미리 준비하고 제공받을 수 있어 편리합니다. 비행기, 숙박, 교통까지 모두 포함된 패키지를 선택하여 미리 준비된 일정대로 안심하고 여행을 즐길 수 있습니다.', 700, now(), null, '패키지여행'),
